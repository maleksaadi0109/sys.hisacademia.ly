    ...
    <section>
        ...
        <div class="container">
            <div class="row">
                ...
                <form method="POST" enctype="multipart/form-data" action="{{ route('generate.general.monthly.report') }}">
                    @csrf
                    <div class="row">
                        ...
                        <div class="row table-responsive">
                            <table class="table table-hover text-center table-bordered">
                                ...
                                <tbody class="table-success">
                                    <tr>
                                        <td scope="col" colspan="9">{{$data['count_course']}}</td>                              
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table table-hover text-center table-bordered">
                                ...
                                <tbody class="table-success">
                                    <tr>
                                        <td scope="col" colspan="9">{{$data['count_translation']}}</th>                              
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table table-hover text-center table-bordered">
                                ...
                                <tbody class="table-success">
                                    <tr>
                                        <td scope="col" colspan="9">{{$data['count_diploma']}}</th>                              
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table table-hover text-center table-bordered">
                                ...
                                <tbody class="table-success">
                                    <tr>
                                        ...
                                        <td scope="col">{{$data['t_diploma_price_usd']}}</td>
                                        <td scope="col">{{$data['t_diploma_rec_usd']}}</td>
                                        <td scope="col">{{$data['t_diploma_rem_usd']}}</td>
                                    </tr>
                                </tbody>
                                <thead class="table-dark">
                                    <tr>
                                        <td scope="col" colspan="3">الاجمالي الكلي</td> 
                                        <td scope="col" colspan="3">المدفوع الكلي</td> 
                                        <td scope="col" colspan="3">المتبقي الكلي</td>                                     </tr>
                                    <tr>
                                </thead>
                                <tbody class="table-success">
                                    <tr>
                                        <td scope="col" colspan="3">{{$data['t_price_usd']}}</td> 
                                        <td scope="col" colspan="3">{{$data['t_rec_usd']}}</td> 
                                        <td scope="col" colspan="3">{{$data['t_rem_usd']}}</td> 
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table table-hover text-center table-bordered">
                                ...
                                <tbody class="table-success">
                                    <tr>
                                        ...
                                        <td scope="col">{{$data['t_diploma_price_D']}}</td>
                                        <td scope="col">{{$data['t_diploma_rec_D']}}</td>
                                        <td scope="col">{{$data['t_diploma_rem_D']}}</td>
                                    </tr>
                                </tbody>
                                ...
                                <tbody class="table-success">
                                    <tr>
                                        <td scope="col" colspan="3">{{$data['t_price_D']}}</td> 
                                        <td scope="col" colspan="3">{{$data['t_rec_D']}}</td> 
                                        <td scope="col" colspan="3">{{$data['t_rem_D']}}</td> 
                                    </tr>
                                </tbody>
                            </table>
                        </div>
