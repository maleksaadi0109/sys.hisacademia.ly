    ...
    <div class="container">
        <div class="row table-responsive">
            <table class="table table-light table-hover text-center">
                <thead>
                    <tr>
                        <th scope="col"><a href="{{route('teachers',['orderBy' => 'id','sort' => 'asc'])}}"># <i class="fas fa-sort text-right"></a></th>
                        <th scope="col">اسم المعلم</th>
                        <th scope="col"><a href="{{route('teachers',['orderBy' => 'en_name','sort' => 'asc'])}}">اسم المعلم بالانجليزي<i class="fas fa-sort text-right"></a></th>                              
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td scope="row"><a class="me-2 btn btn-lg edit-button" data-mdb-ripple-init="" href="{{route('edit.teacher',['id' => $teacher->id])}}"><i class="far fa-edit"></i></a></td>
