...
@section('content')
    <section>
        <header>
            <h2 class="text-lg font-medium text-gray-900">{{__('إضافة معاملة')}}</h2>
        </header>

        <div class="container">
            <div class="row">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('register.translation_deal') }}">
                        @csrf
                        <div class="row">
                            ...
                            <div class="mt-4 col-lg-6">
                                ...
                                <x-text-input id="number_of_sheets" value="{{old('number_of_sheets')}}" class="block mt-1 w-full" type="number" name="number_of_sheets" required  autofocus autocomplete="number_of_sheets" />
                            ...
                            <div class="mt-4 col-lg-6">
                                ...
                                <x-text-input id="number_of_transaction" value="{{old('number_of_transaction')}}" class="block mt-1 w-full" type="number" name="number_of_transaction" required  autofocus autocomplete="number_of_transaction" />
                            ...
                            <div class="mt-4 col-lg-6">
                                ...
                                <x-text-input id="context" value="{{old('context')}}" class="block mt-1 w-full" type="text" name="context"  required autofocus autocomplete="context" />
                            ...
                            <div class="mt-4 col-lg-6">
                                ...
                                <x-text-input id="language" value="{{old('language')}}" class="block mt-1 w-full" type="text" name="language"  required autofocus autocomplete="language" />
                            ...
                            <div class="mt-4 col-lg-6">
                                ...
                                <x-text-input id="translator_share" value="{{old('translator_share')}}" class="block mt-1 w-full" type="number" name="translator_share" required  autofocus autocomplete="translator_share" />
                            ...
                            <div class="mt-4 col-lg-6">
                                ...
                                <x-text-input id="academy_share" value="{{old('academy_share')}}" class="block mt-1 w-full" type="number" name="academy_share" required  autofocus autocomplete="academy_share" />
                            ...
                            <div class="mt-4 col-lg-6">
                                ...
                                <x-text-input id="received" value="{{old('received')}}" class="block mt-1 w-full" type="number" name="received" required  autofocus autocomplete="received" />
                            ...
                            <div class="mt-4 col-lg-6">
                                ...
                                <x-text-input id="remaining" value="{{old('remaining')}}" class="block mt-1 w-full" readonly type="number" name="remaining" required  autofocus autocomplete="remaining" />
                            ...
                            <div class="mt-4 col-lg-6">
                                ...
                                <input type="date" readonly value="{{date('Y-m-d',strtotime(now()))}}" id="date_of_receipt" name="date_of_receipt" required class="form-control block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-s" />
                            </div>

                            <!-- due date -->
                            <div class="mt-4 col-lg-6">
                                <label for="due_date" class="block font-medium text-sm text-gray-700">تاريخ الاستحقاق </label>
                                <input type="date" id="due_date"  value="{{old('due_date')}}"  name="due_date" required class="form-control block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-s" />
                                @php
