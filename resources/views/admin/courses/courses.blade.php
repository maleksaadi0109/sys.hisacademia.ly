    ...
    <div class="container">
        <div class="row table-responsive">
            <table class="table table-light table-hover text-center">
                <thead>
                    <tr>
                        <th scope="col"><a href="{{route('courses',['orderBy' => 'id','sort' => 'asc'])}}"># <i class="fas fa-sort text-right"></a></th>
                        <th scope="col"><a href="{{route('courses',['orderBy' => 'name','sort' => 'asc'])}}">اسم الكورس <i class="fas fa-sort text-right"></a></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td scope="row"><a class="me-2 btn btn-lg edit-button" data-mdb-ripple-init="" href="{{route('edit.course',['id' => $course->id])}}"><i class="far fa-edit"></i></a></td>
                        
                        <td><a class="btn btn-sm delete-button " data-mdb-ripple-init="" href="{{route('course.destroy',['id' => $course->id])}}"
                            onclick="event.preventDefault();document.getElementById('delete-form-{{ $course->id }}').submit();">
                            <i class="far fa-trash-alt"></i></a></td>

                        <form id="delete-form-{{ $course->id }}" action="{{route('course.destroy',['id' => $course->id])}}"
