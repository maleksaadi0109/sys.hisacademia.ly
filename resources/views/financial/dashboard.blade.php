            ...
            <div class="position-sticky pt-3">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse div-collapse" id="collapse-1" style="">
                            <ul class="nav flex-column ul-collapse">
                                <li class="li-collapse"><a href="{{route('financial.revenues',['orderBy' => 'null','sort' => 'null'])}}" class="link-white d-inline-flex text-decoration-none rounded">إيرادات الكورسات</a></li>
                                <li class="li-collapse"><a href="{{route('financial.translation_revenues',['orderBy' => 'null','sort' => 'null'])}}" class="link-white d-inline-flex text-decoration-none rounded">إيرادات الترجمة</a></li>
                                <li class="li-collapse"><a href="{{route('financial.teacher_revenue')}}" class="link-white d-inline-flex text-decoration-none rounded">إيرادات المعلم</a></li>
                                <li class="li-collapse"><a href="{{route('financial.diploma.revenues')}}" class="link-white d-inline-flex text-decoration-none rounded">إيرادات الدبلوم</a></li>
                                <li class="li-collapse"><a href="{{route('financial.expenses',['orderBy' => 'null','sort' => 'null'])}}" class="link-white d-inline-flex text-decoration-none rounded">مصروفات</a></li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse div-collapse" id="collapse-1" style="">
                            <ul class="nav flex-column ul-collapse">
                                <li class="li-collapse"><a href="{{route('financial.general.monthly.report')}}" class="link-white d-inline-flex text-decoration-none rounded">التقرير الشهري الشامل</a></li>
                                <li class="li-collapse"><a href="{{route('financial.course.report')}}" class="link-white d-inline-flex text-decoration-none rounded">تقرير الكورسات</a></li>
                                <li class="li-collapse"><a href="{{route('financial.translation.report')}}" class="link-white d-inline-flex text-decoration-none rounded">تقرير الترجمة</a></li>
                            </ul>
                        </div>
                    </li>
                    @endif
