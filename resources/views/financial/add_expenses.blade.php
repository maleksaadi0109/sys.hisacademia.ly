...
@section('content')
    <section>
        <header>
            <h2 class="text-lg font-medium text-gray-900">{{__('إضافة فاتورة مصروف')}}</h2>
        </header>

        <div class="container">
            <div class="row">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('financial.register.expense') }}">
                        @csrf
                        <div class="row">
                            ...
                            <!-- review number -->
                            <div class="mt-4 col-lg-6">
                                <x-input-label for="review_number" :value="__('رقم المراجعة')" />
                                <x-text-input id="review_number" value="{{old('review_number')}}" class="block mt-1 w-full" type="text" name="review_number" required  autofocus autocomplete="review_number" />
                            ...
                            <div class="mt-4 col-lg-6">
                                ...
                                <x-text-input id="value" value="{{old('value')}}" class="block mt-1 w-full" type="number" min="0" name="value" required  autofocus autocomplete="value" />
                            ...
                            <div class="mt-4 col-lg-6">
                                ...
                                <input type="date" id="date"  value="{{old('date')}}"  name="date" required class="form-control block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-s" />
                                @php
