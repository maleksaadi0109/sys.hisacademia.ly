    ...
    <div class="container">
        <div class="row table-responsive">
            <table class="table table-light table-hover text-center">
                <thead>
                    <tr>
                        <th scope="col"><a href="{{route('financial.translation_revenues',['orderBy' => 'id','sort' => 'asc'])}}"># <i class="fas fa-sort text-right"></a></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td scope="row">
                            @if($translationDeal->remaining > 0)
                            <a class="me-2 btn btn-lg edit-button" data-mdb-ripple-init="" href="{{route('financial.edit.translation_revenue',['id' => $translationDeal->id])}}"><i class="far fa-edit"></i></a>
                            @endif
                        </td>
                        <td scope="row"><a class="me-2 btn btn-lg edit-button" data-mdb-ripple-init="" href="{{route('financial.print_translation_bill',['id' => $translationDeal->id])}}"><i class="fas fa-print"></i></a></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
