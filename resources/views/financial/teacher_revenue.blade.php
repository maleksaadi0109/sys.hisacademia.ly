    ...
    <div class="container">
        <div class="row table-responsive">
            ...
            <div class="mt-5 col-lg-12">
                <form method="POST" enctype="multipart/form-data" action="{{ route('financial.print_teacher_bill') }}">
                @csrf
...
<script>
    ...
    function callAjaxForCourse(teacher_id) {
        $.ajax({
            url        :window.location.origin +'/public/financial/course_byteacher/'+teacher_id,
            type       :'GET',
            dataType   :'JSON',
            success    :'success',
