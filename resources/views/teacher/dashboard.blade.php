                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse div-collapse" id="collapse-1" style="">
                            <ul class="nav flex-column ul-collapse">
                                <li class="li-collapse"><a href="{{route('teacher.courses')}}" class="link-white d-inline-flex text-decoration-none rounded">الكورسات</a></li>
                                <li class="li-collapse"><a href="{{route('teacher.teacher.calendar')}}" class="link-white d-inline-flex text-decoration-none rounded">الروزنامة</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
