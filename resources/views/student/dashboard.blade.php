...
<x-app-layout>
    <x-slot name="header">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="/student/dashboard"><img class="header-logo" src="{{asset('logo.jpg')}}">الأكاديمية الإسبانية الليبية</a>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse div-collapse" id="collapse-1" style="">
                            <ul class="nav flex-column ul-collapse">
                                <li class="li-collapse"><a href="{{route('student.courses')}}" class="link-white d-inline-flex text-decoration-none rounded">الكورسات</a></li>
                                <li class="li-collapse"><a href="{{route('student.student.calendar')}}" class="link-white d-inline-flex text-decoration-none rounded">الروزنامة</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
