            ...
            <div class="position-sticky pt-3">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse div-collapse" id="collapse-1" style="">
                            <ul class="nav flex-column ul-collapse">
                                <li class="li-collapse"><a href="{{route("data_entry.course.calendar")}}" class="link-white d-inline-flex text-decoration-none rounded">روزنامة الكورس</a></li>
                                <li class="li-collapse"><a href="{{route("data_entry.teacher.calendar")}}" class="link-white d-inline-flex text-decoration-none rounded">روزنامة المعلم</a></li>
                                <li class="li-collapse"><a href="{{route("data_entry.student.calendar")}}" class="link-white d-inline-flex text-decoration-none rounded">روزنامة الطالب</a></li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse div-collapse" id="collapse-workspace">
                            <ul class="nav flex-column ul-collapse">
                                <li class="li-collapse"><a href="{{route('data_entry.coworking')}}" class="link-white d-inline-flex text-decoration-none rounded">إدارة مساحات العمل</a></li>
                                <li class="li-collapse"><a href="{{route('data_entry.bookinglist') }}" class="link-white d-inline-flex text-decoration-none rounded">إدارة الحجوزات</a></li>
                            </ul>
                        </div>
                    </li>
                    <!-- End New Section -->
