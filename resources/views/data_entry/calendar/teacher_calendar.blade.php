...
@section('content')
    <section>
        <header>
            <h2 class="text-lg font-medium text-gray-900">{{__('روزنامة المعلم')}}</h2>
        </header>
        <div class="container">
            <div class="row table-responsive">
                ...
                <div class="mt-5 col-lg-12">
                    <div class="input-group mb-3">
                        <label class="input-group-text" for="selectteacherchange">المعلم</label>
                        <select class="form-select" id="selectteacherchange" name="teacher_id" required>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#this_week").button().click(function(){
                ...
                var teacher_id = $('#selectteacherchange').val();
                callAjaxForTeacher(teacher_id);
            });
            ...
            $('#selectteacherchange').change(function (){
            ...
            function callAjaxForTeacher(teacher_id) {
                $.ajax({
                    url: window.location.origin + '/data_entry/calendar_byteacher/' + teacher_id,
                    type: 'GET',
                    dataType: 'JSON',
