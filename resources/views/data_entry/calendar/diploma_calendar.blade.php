...
<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900">{{__('روزنامة الدبلوم')}}</h2>
    </header>
    <div class="container">
...
$(document).ready(function () {
    ...
    function callAjaxForDiploma(diploma_id) {
        $.ajax({
            url        :window.location.origin +'/data_entry/calendar_bydiploma/'+diploma_id,
            type       :'GET',
            dataType   :'JSON',
