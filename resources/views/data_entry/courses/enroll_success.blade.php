...
@section('content')
    <section>
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600">{{__('تم تسجيل الكورس للطالب بنجاح. اختر الخطوة التالية:')}}</p>
        </header>
                    ...
                    <div class="card mb-4 border-success">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <strong>اسم الكورس:</strong> {{ $revenue->course->name }}
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="card h-100 border-info">
                                <div class="card-body text-center">
                                    ...
                                    <h4 class="card-title text-info">حجز كورس آخر</h4>
                                    <p class="card-text text-muted">
                                        تسجيل الطالب في كورس آخر
                                    </p>
                                    <div class="mt-4">
                                        <a href="{{ route('data_entry.buy.course') }}" 
