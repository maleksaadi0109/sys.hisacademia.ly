...
// Create Table Helper - نسخة محسنة مع headers
            function createTable(tableData, table, showHeaders = false) {
                // إضافة الـ headers مرة واحدة بس في أول مرة
                if (showHeaders && table.children.length === 0) {
                    var headerRow = document.createElement('tr');
                    ['البيان', 'القيمة', 'البيان', 'القيمة'].forEach(function(headerText) {
                ...
                separatorCell.style.borderBottom = '3px solid #dee2e6';
