    ...
    $(document).ready(function () {
        ...
        $('#table_diploma_time').hide();
            ...
            function SelectDiplomaChange(element) {
                ...
                var diploma_price = element.find(':selected').data('price');
                $.ajax({
                    url        :window.location.origin +'/public/data_entry/time_by_diploma/'+diploma_id,
                    type       :'GET',
                    dataType   :'JSON',
                    success    :'success',
            ...
            function SelectStudentChange(element) {
                ...
                $.ajax({
                    url        :window.location.origin +'/public/data_entry/time_by_student/'+student_id,
                    type       :'GET',
                    dataType   :'JSON',
                    success    :'success',
                    success    :function(result){
