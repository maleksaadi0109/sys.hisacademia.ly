            ...
            <table class="table table-light table-hover text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td scope="row"><a class="me-2 btn btn-lg edit-button" data-mdb-ripple-init="" href="{{route('data_entry.edit.translation_deal',['id' => $translationDeal->id])}}"><i class="far fa-edit"></i></a></td>
                        <td><a class="btn btn-sm delete-button " data-mdb-ripple-init="" href="{{route('data_entry.translation_deal.destroy',['id' => $translationDeal->id])}}"
                            onclick="event.preventDefault();document.getElementById('delete-form-{{ $translationDeal->id }}').submit();">
                            <i class="far fa-trash-alt"></i></a></td>

                        <form id="delete-form-{{ $translationDeal->id }}" action="{{route('data_entry.translation_deal.destroy',['id' => $translationDeal->id])}}"
